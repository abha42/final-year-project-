...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/complaint/web/create_complaint.php', {
...
/************************** admin Details *********************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/complaint/web/admin_get.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/************************** User View Complaint *********************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/complaint/web/complaint_get.php', {'email': $scope.cook_user_email})
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/complaint/web/create_feedback.php', 
		{
...
$scope.user_update_info = function(name,password,mobile) 
	...
	{		
		$http.post('http://10.0.2.2/projects/complaint/web/user_update_info.php',{
...
$scope.update_id = function(cus_id) 
	...
	{		
        ...
        $http.post('http://10.0.2.2/projects/complaint/web/update_location.php', 
			{	
